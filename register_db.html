<?php 
    ...
    if (isset($_POST['reg_user'])) {
        ...
        $user_check_query = "SELECT * FROM database1 WHERE username = '$username' OR email = '$email' LIMIT 1"; 
        ...
        if (count($errors) == 0) {
            ...
            $sql = "INSERT INTO database1 (username, email, password) VALUES ('$username', '$email', '$password')"; 
